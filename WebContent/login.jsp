...
<body background="timg.jpg">
	...
	<div class="container w3layouts agileits">
		...
		<div class="login w3layouts agileits">
			...
			<form action="loginServlet" method="post">
				...
				<div class="send-button w3layouts agileits">
					<p><input type="submit" value="登录"></p><br>
					<p><input type="button" value="返回首页" onclick="javascrtpt:window.location.href='index.jsp'"></p>
				</div>
			</form>
			<div class="clear"></div>
		</div>
		<div class="register w3layouts agileits">
			...
			<form action="register" method="post">
				<input type="text" name="txtNick" placeholder="用户名" >
				<input type="text" name="txtEmail" placeholder="邮箱" >
				<input type="password" name="txtPwd" placeholder="密码" >
				<input type="text" name="txtPhone" placeholder="手机号码" >
			<div class="send-button w3layouts agileits">
	...
	<div>
		<br>
		<p align="center"> Copyright © Ahstu</p>
	</div>
</body>
</html>